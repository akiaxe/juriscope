...
main_folder='/home/ahm50/data/20_4_26/' # Give the file directory you are saving to

objective=40 # Set either 20 or 40 for which objective is being used

samples=1 #How many wells/capillaries do you have

sample_names=['fine_step_invertase_2.005']

z_stack=0# Say if a z stack is being used; 1=yes, 0= not
timelapse=0 # say if you want time lapse on; 1=yes, 0= not
...
illumination=[0x01,0x40,0x20] # change depending on which channel is being used
illum_expose=[100000, 200000, 100000] # change depending on exposure time for each channel
laser_pwr=[1,1,1] # change depending on the laser power wanted, between 0 and 1
